...
class FrontPage(SeleniumDriver):
    ...
    def get_popular_product_cards(self):
        return self.driver.find_elements(*self._popular_product_names)

    def get_best_sellers_product_cards(self):
        return self.driver.find_elements(*self._best_sellers_product_names)
    ...
    def verify_popular_items(self, first_item, last_item):
        self.driver.find_element(*self._popular_btn).click()
    ...
    def verify_best_sellers_items(self, first_item, last_item):
        self.driver.find_element(*self._best_sellers_btn).click()
    ...
    def verify_search_dropdown(self):
        search_box = self.driver.find_element(*self._search_box)
    ...
    def verify_search_results(self):
        ...
        # heading = self.util.wait(self.driver).until(lambda dr: dr.find_element(*self._printed_title))
